...
for (const simpson of simpsons){
    ...
    div1.innerText = simpson.surname;
    document.body.appendChild(div1);
    let div2 = document.createElement('div');
    div2.innerText = simpson.age;
    div2.classList.add('member');
    document.body.appendChild(div2);
    let div3 = document.createElement('div');
    div3.innerText = simpson.info;
...
for (const cours of coursesArray){
    ...
    let div = document.createElement('div');
    div.innerText = cours.title;
    document.body.appendChild(div);
    let p = document.createElement('p');
    p.innerText = `${cours.monthDuration}  ${cours.hourDuration}`;
   div.appendChild(p);
    let ul = document.createElement('ul');
    document.body.appendChild(ul);
    for (const liItem of cours.modules) {
